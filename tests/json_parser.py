...
class TestJSONParser(unittest.TestCase):
    ...
    def test_gcal_event_kernel(self):
        ...
        self.assertEqual(22, first_group.template_event.attributedToId)  # group ID
        self.assertEqual("family_education", first_group.template_event.category.name)
        self.assertEqual("93", first_group.template_event.picture.mediaId)
    ...
    def test_farmers_event_kernel(self):
        ...
        self.assertEqual(25, first_group.template_event.attributedToId) # group ID
        self.assertEqual("food_drink", first_group.template_event.category.name)
        self.assertEqual("96", first_group.template_event.picture.mediaId)
